import moniles from './../assets/mobiles.png'
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-6 relative z-10">
              ...
              <div className="flex flex-wrap gap-4">
                {/* App Store Button */}
                <a href="#" className="bg-black text-white px-6 py-2 rounded-lg flex items-center gap-2 hover:bg-gray-900 transition-colors">
